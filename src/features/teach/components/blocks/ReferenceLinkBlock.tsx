...
export function ReferenceLinkBlock({ block }: ReferenceLinkBlockProps) {
  ...
  return (
    <button
      ...
      className="group inline-flex w-full items-center gap-2 rounded-md border border-border bg-background px-3 py-2 text-start text-sm font-semibold text-foreground transition-colors hover:border-primary/60 hover:bg-muted"
    >
