...
export function TeachWorkspace({ lang }: TeachWorkspaceProps) {
  ...
  const compactActionClass = 'size-8 rounded-lg px-0 sm:w-auto sm:px-2.5'
    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      >
        <DialogContent className="teach-workspace-theme sm:max-w-[440px]">
          ...
          {pendingImport && (
            <p className="truncate rounded-xl border border-border/70 bg-muted/55 px-3 py-2 text-xs text-muted-foreground">
              {pendingImport.name}
            </p>
          )}
