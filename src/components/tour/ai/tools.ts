...
function requireClassroom(bridge: AIBridgeValue): AIClassroomBridge {
  if (!bridge.classroom)
...
function readConcepts(bridge: AIBridgeValue, ids?: string[]) {
...
export function createChatAgentToolkit(bridge: AIBridgeValue): Toolkit {
  return {
...
export function createLessonAuthorToolkit(bridge: AIBridgeValue): Toolkit {
  return {
    read_classroom_state: {
