  ...
  return (
    ...
    >
      <ThreadPrimitive.Viewport
        ...
        // - overflow-y-scroll forces an always-on scrollbar so the gutter
        //   never appears/disappears mid-animation.
        // - assistant-ui's useScrollLock hides the scrollbar during reasoning/
        //   tool collapse animations by setting `scrollbar-width: none` inline;
        //   we override that with !important so the gutter stays reserved and
        ...
        >
          {({ part, children }) => {
            switch (part.type) {
              ...
              case 'group-tool':
                // Skip the ToolGroup wrapper for a single tool call — the
                // group header just adds visual noise without aggregation.
                // The `mb-4` matches `ReasoningRoot`'s built-in bottom margin
                // so adjacent reasoning/tool blocks share the same rhythm.
